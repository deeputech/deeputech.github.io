...
date: 2018-11-19
---
import CodeSandbox from "~/components/embeds/CodeSandbox.astro";
import SpeakerDeck from "~/components/embeds/SpeakerDeck.astro";
...
<YouTube id="SBwGH4kbkms" />

<SpeakerDeck id="ffe22480dbfd4c1f83f66c380bba2283" />
